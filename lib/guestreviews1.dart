...
class GuestReviews1 extends StatefulWidget {
  GuestReviewsState1 createState() => GuestReviewsState1();
}

class GuestReviewsState1 extends State<GuestReviews1> {
  List<Review> reviews = [];
  ...
  Future<void> fetchReviews() async {
    try {
      List<Review> fetchedReviews = await objectbox.getReviews('visitor');
      setState(() {
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(
      cells: [
        ...
        // DataCell(Image.file(File(review.profilePic!), width: 50)),
